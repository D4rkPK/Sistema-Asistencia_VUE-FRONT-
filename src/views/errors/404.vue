<template>
  <v-container class="content_error">
    <div class="row">
      <!-- <img style="content: var(--logoMEM)" alt="Logo MEM" /> -->
    </div>
    <hr />
    <div class="row">
...
<style scoped src="./styles/404.css"></style>
